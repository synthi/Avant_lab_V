-- Avant_lab_V lib/scales.lua | Version 102.0
-- REORGANIZED: Priority on Vintage Lab & Vocoders
...
Scales.list = {
  ...
  {name = "Siemens Oct", data = {60, 120, 240, 480, 960, 1920, 3840, 7680, 11000, 14000, 16000, 18000, 19000, 20000, 21000, 22000}},
  {name = "B&K 2112", data = {63, 125, 250, 500, 1000, 2000, 4000, 8000, 16000, 20000, 2500, 3150, 5000, 6300, 10000, 12500}},
  {name = "B&K 2107", data = {30, 50, 85, 140, 240, 400, 650, 1000, 1600, 2500, 4000, 6300, 10000, 16000, 20000, 24000}},
  ...
  {name = "HP 3580", data = {20, 45, 80, 150, 280, 500, 900, 1500, 2500, 4000, 6000, 8500, 11000, 14000, 17000, 20000}},
  ...
  {name = "EMS Voc", data = {120, 160, 220, 300, 400, 540, 720, 960, 1280, 1700, 2250, 3000, 4000, 5300, 7000, 9500}},
  ...
  {name = "Sennheiser", data = {100, 180, 260, 330, 470, 660, 800, 930, 1310, 1600, 1850, 2600, 3000, 3650, 4500, 5100}},
