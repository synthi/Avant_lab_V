-- Avant_lab_V lib/scales.lua | Version 2020
-- UPDATE: Distinct Physics for Marimba/Vibes. Fixed Bohlen-Pierce >18k violation.
...
Scales.list = {
  ...
  -- [FIX] Bohlen-Pierce now ends safe (<18k)
